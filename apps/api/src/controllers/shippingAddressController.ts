...
import { createAddress, getAllAddressesByUserId, getAddressById, updateAddress, deleteAddress } from '../services/shippingAddressServices.ts';
...
export const getAllAddressesByUserIdController = async (req: Request, res: Response) => {
  try {
