        ...
        <nav>
          <ul>
            <li className="mb-2">
              <a
                href="#"
                className="font-semibold flex items-center p-2 text-gray-50 hover:text-third"
              >
            ...
            <li className="mb-2">
              <a
                href="#"
                className="flex items-center p-2 font-semibold text-gray-50 hover:text-third"
              >
