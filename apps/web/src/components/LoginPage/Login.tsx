...
const LoginPage = () => {
  ...
  return (
    <div className="flex bg-gray-50 gap-1 justify-center items-center py-4">
      ...
      <div className="max-w-md p-6 mr-48 bg-secondary border border-gray-300 rounded-md shadow-md">
        ...
        <form onSubmit={login} method="POST">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 bg-primary hover:bg-third text-white rounded-md"
          >
            Log In
          </button>
